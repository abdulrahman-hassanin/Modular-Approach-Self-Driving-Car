...
class BehaviorAgent(Agent):
    ...
    def __init__(self, vehicle, ignore_traffic_light=False, behavior='normal'):
        ...
        - ignore_traffic_light: boolean to ignore any traffic light
    ...
    def update_information(self):
        ...
        #print(f"Look ahead = {self.look_ahead_steps}")

        # Incoming waypoints and direction
        self.incoming_waypoint, self.incoming_direction = self._local_planner.get_incoming_waypoint_and_direction(steps=self.look_ahead_steps-3)
    ...
    def set_destination(self, start_location, end_location, clean=False):
        ...
        Parameters:
        - start_location: initial position
        - end_location: final position
        - clean: boolean to clean the waypoint queue
        """
    ...
    def reroute(self, spawn_points):
        ...
        Parameters:
        - spawn_points: list of possible destinations for the agent
        """
    ...
    def _trace_route(self, start_waypoint, end_waypoint):
        ...
        Parameters:
        - start_waypoint: initial position
        - end_waypoint: final position
    ...
    def collision_and_car_avoid_manager(self, location, waypoint, vehicle_list):
        """
        ...
        Return:
        - vehicle_state: True if there is a vehicle nearby, False if not
        - vehicle: nearby vehicle
        - distance: distance to nearby vehicle
        """
    ...
    def pedestrian_avoid_manager(self, location, waypoint):
        ...
        Return:
        - walker_state: True if there is a walker nearby, False if not
        - walker: nearby walker
        - distance: distance to nearby walker
        """
    ...
    # Run step
    def run_step(self, vehicle_list, pedstrain_list, debug=False):
        """
        ...
        # Ego vehicle location and waypoint
        ...
        vehicle_state, vehicle, distance = self.collision_and_car_avoid_manager(ego_vehicle_loc, ego_vehicle_wp, vehicle_list)      
