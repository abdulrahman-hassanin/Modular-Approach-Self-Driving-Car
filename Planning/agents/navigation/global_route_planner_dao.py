...
# Global route planner DAO class
class GlobalRoutePlannerDAO(object):
    ...
    def __init__(self, wmap, sampling_resolution):
		...
		Parameters:
        - wmap: carla.world object
        - sampling_resolution: sampling distance between waypoints
        """
    ...
    def get_topology(self):
        ...
        Return:
        topology: list of dictionary objects with the following attributes
            ...
            path     :  list of waypoints separated by 1m from entry to exit
        """
    ...
    def get_waypoint(self, location):
        ...
        Return: 
        - waypoint: generated waypoint close to location
        """
