...
class BehaviorAgent(Agent):
    ...
    # Initialization
    def __init__(self, vehicle, PID_params=None, ignore_traffic_light=False, behavior='normal'):
        """
        Constructor method.
        ...
        self._local_planner = LocalPlanner(vehicle, PID_params)
        self._grp = None
    ...
    def collision_and_car_avoid_manager(self, location, waypoint):
        ...
        print(vehicle_list)
        def dist(v):
            x = v.get_location().distance(waypoint.transform.location)
            #if v.id != self.vehicle.id and x<10:
               # print(x)
            return x
        ...
        # m = []
        # for v in l:
        #     m.append(v.get_location())
        # print(m)
        

        # Check for turn directions
        ...
        # Return vehicle_state , vehicle and distance 
        return vehicle_state, vehicle, distance

    # Pedestrian avoid manager
    def pedestrian_avoid_manager(self, location, waypoint):
        ...
        Return: 
        - vehicle_state: True if there is a walker nearby, False if not
        - vehicle: nearby walker
        ...
        # Return walker_state , walker and distance
    ...
    def run_step(self, debug=False):
        ...
        # Get ego vehicle location and waypoint
