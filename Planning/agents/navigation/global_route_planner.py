...
class GlobalRoutePlanner(object):
    ...
    def _build_graph(self):
        ...
        Return:  
        - graph           : networkx graph representing the world map,
    ...
    def _localize(self, location):
        ...
        Return:
        - pair node ids representing an edge in the graph
        """
    ...
    def _path_search(self, origin, destination):
        ...
        Return:
        - path as list of node ids (as int) of the graph self._graph connecting origin and destination
        """
    ...
    # Last successive intersection edge
    def _successive_last_intersection_edge(self, index, route):
        ...
        # Initialize last successive intersection edge and last node
        ...
        # Return last node and last successive intersection edge 
    ...
    def abstract_route_plan(self, origin, destination):
        """
        The following function generates the route plan based on parameters
        ...
        Return:
        - list of turn by turn navigation decisions as
    ...
    def _find_closest_in_list(self, current_waypoint, waypoint_list):
        """
        Find closeset waypoints from  list of waypoints
        ...
        # Initialize minimum distance and current index
    ...
    def trace_route(self, origin, destination):
        ...
        # Initialize route trace
        route_trace = []

        # Get route between origin and destination
        route = self._path_search(origin, destination)

        # Get cuurent and destination waypoints and resolution
